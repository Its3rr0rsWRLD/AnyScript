...
local function KCME_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(KCME_fake_script)()
local function JZKX_fake_script() -- TextButton_3.LocalScript 
...
coroutine.wrap(JZKX_fake_script)()
local function KQEJX_fake_script() -- TextButton_5.LocalScript 
...
coroutine.wrap(KQEJX_fake_script)()
local function KZUVFSI_fake_script() -- ApplyBtn.LocalScript 
...
coroutine.wrap(KZUVFSI_fake_script)()
local function PZUZ_fake_script() -- CancelBtn.LocalScript 
...
coroutine.wrap(PZUZ_fake_script)()
local function IDDTY_fake_script() -- WalkSpeedFrame.LocalScript 
	local script = Instance.new('LocalScript', WalkSpeedFrame)

	
end
coroutine.wrap(IDDTY_fake_script)()
local function WYML_fake_script() -- ApplyBtn_2.LocalScript 
...
coroutine.wrap(WYML_fake_script)()
local function QDOP_fake_script() -- CancelBtn_2.LocalScript 
...
coroutine.wrap(QDOP_fake_script)()
local function PDMTALA_fake_script() -- X.LocalScript 
...
coroutine.wrap(PDMTALA_fake_script)()
local function JYLM_fake_script() -- Frame2Shadow.LocalScript 
...
coroutine.wrap(JYLM_fake_script)()
local function SXNNDEO_fake_script() -- KeyShadow.LocalScript 
...
coroutine.wrap(SXNNDEO_fake_script)()
local function JDZJXW_fake_script() -- TextBox.LocalScript 
...
coroutine.wrap(JDZJXW_fake_script)()
local function UMZYTV_fake_script() -- Open.LocalScript 
...
coroutine.wrap(UMZYTV_fake_script)()
local function VARQZT_fake_script() -- Open.LocalScript 
	local script = Instance.new('LocalScript', Open)
...
coroutine.wrap(VARQZT_fake_script)()
